...
namespace TuncayAlbayrakMvcSinav.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ulke = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Filmler_AspNetUsers_YonetmenId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OyuncuFilmId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OyuncuId = table.Column<int>(type: "int", nullable: false),
                    FilmId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OyuncuFilmler", x => x.OyuncuFilmId);
                    table.ForeignKey(
